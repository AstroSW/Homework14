...
public class App {
    public static void main(String[] args) {
        ...
        searchEngine.addInfo(new DiscountedProduct("Смартфон Xiaomi Redmi", 20999, 10));
        searchEngine.addInfo(new FixPriceProduct("Смартфон Samsung Galaxy"));
        searchEngine.addInfo(new SimpleProduct("Смартфон POCO X9", 35499));
        searchEngine.addInfo(new DiscountedProduct("Смартфон HONOR V312", 29499, 35));
